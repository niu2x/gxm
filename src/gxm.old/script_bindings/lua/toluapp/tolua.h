...
TOLUA_API int  tolua_isusertable(
     lua_State *  L,
     int          lo,
     const char * type,
     int          def,
...
TOLUA_API int tolua_isusertype(
    lua_State *  L,
    int          lo,
    const char * type,
    int          def,
...
TOLUA_API void tolua_pushfieldstring(
    ...
    int         index,
    const char *v);
TOLUA_API void tolua_pushfielduserdata(
    lua_State *L,
    int        lo,
    int        index,
    void *     v);
TOLUA_API void tolua_pushfieldusertype(
    lua_State * L,
    int         lo,
    int         index,
    void *      v,
...
TOLUA_API double      tolua_tofieldnumber(
         lua_State *L,
         int        lo,
         int        index,
         double     def);
...
TOLUA_API const char *tolua_tofieldstring(
    ...
    int         index,
    const char *def);
TOLUA_API void *tolua_tofielduserdata(
    lua_State *L,
    int        lo,
    int        index,
    void *     def);
TOLUA_API void *tolua_tofieldusertype(
    lua_State *L,
    int        lo,
    int        index,
    void *     def);
